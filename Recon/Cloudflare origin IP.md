...
--
**Virustotal**
https://www.virustotal.com/vtapi/v2/domain/report?domain=nasa.gov&apikey=76d7e13aa9b40e62cd4b096a09a1de19ba6bb70f0e158dd558dfe44c86ab08d0

curl -s "https://www.virustotal.com/vtapi/v2/domain/report?domain=nasa.gov&apikey=76d7e13aa9b40e62cd4b096a09a1de19ba6bb70f0e158dd558dfe44c86ab08d0" | jq -r '.. | .ip_address? // empty' | grep -Eo '([0-9]{1,3}\.){3}[0-9]{1,3}' | httpx -sc -td -title -server
