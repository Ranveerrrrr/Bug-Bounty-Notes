...
#### Scenario 2:
**Attacker:** trying to connect his vercel account with github enters his creds and when clicks to connect he drops that request and copy the link that will connect and send it to victim.
